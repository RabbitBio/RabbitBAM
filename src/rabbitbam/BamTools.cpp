...
// NOTE: writer-only helpers removed from the vendored read-only subset:
//   find_divide_pos(bam_block*), find_divide_pos(bam_complete_block*),
//   rabbit_bgzf_compress(), rabbit_bgzf_gzip_compress().
// The reader uses only find_divide_pos_and_get_read_number() (below).
